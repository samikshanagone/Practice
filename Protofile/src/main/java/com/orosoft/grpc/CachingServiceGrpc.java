...
public final class CachingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.orosoft.grpc.UserSessionRequest,
      com.orosoft.grpc.UserSession> getGetUserSessionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getUserSession",
      requestType = com.orosoft.grpc.UserSessionRequest.class,
      responseType = com.orosoft.grpc.UserSession.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.orosoft.grpc.UserSessionRequest,
      com.orosoft.grpc.UserSession> getGetUserSessionMethod() {
    io.grpc.MethodDescriptor<com.orosoft.grpc.UserSessionRequest, com.orosoft.grpc.UserSession> getGetUserSessionMethod;
    if ((getGetUserSessionMethod = CachingServiceGrpc.getGetUserSessionMethod) == null) {
      synchronized (CachingServiceGrpc.class) {
        if ((getGetUserSessionMethod = CachingServiceGrpc.getGetUserSessionMethod) == null) {
          CachingServiceGrpc.getGetUserSessionMethod = getGetUserSessionMethod = 
              io.grpc.MethodDescriptor.<com.orosoft.grpc.UserSessionRequest, com.orosoft.grpc.UserSession>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "CachingService", "getUserSession"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.orosoft.grpc.UserSessionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.orosoft.grpc.UserSession.getDefaultInstance()))
                  .setSchemaDescriptor(new CachingServiceMethodDescriptorSupplier("getUserSession"))
                  .build();
          }
        }
     }
     return getGetUserSessionMethod;
  }

  private static volatile io.grpc.MethodDescriptor<com.orosoft.grpc.UserSession,
      com.orosoft.grpc.StoreSessionResponse> getStoreUserSessionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "storeUserSession",
      requestType = com.orosoft.grpc.UserSession.class,
      responseType = com.orosoft.grpc.StoreSessionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.orosoft.grpc.UserSession,
      com.orosoft.grpc.StoreSessionResponse> getStoreUserSessionMethod() {
    io.grpc.MethodDescriptor<com.orosoft.grpc.UserSession, com.orosoft.grpc.StoreSessionResponse> getStoreUserSessionMethod;
    if ((getStoreUserSessionMethod = CachingServiceGrpc.getStoreUserSessionMethod) == null) {
      synchronized (CachingServiceGrpc.class) {
        if ((getStoreUserSessionMethod = CachingServiceGrpc.getStoreUserSessionMethod) == null) {
          CachingServiceGrpc.getStoreUserSessionMethod = getStoreUserSessionMethod = 
              io.grpc.MethodDescriptor.<com.orosoft.grpc.UserSession, com.orosoft.grpc.StoreSessionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "CachingService", "storeUserSession"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.orosoft.grpc.UserSession.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.orosoft.grpc.StoreSessionResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new CachingServiceMethodDescriptorSupplier("storeUserSession"))
                  .build();
          }
        }
     }
     return getStoreUserSessionMethod;
  }

  private static volatile io.grpc.MethodDescriptor<com.orosoft.grpc.RemoveSessionRequest,
      com.orosoft.grpc.RemoveSessionResponse> getRemoveUserSessionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "removeUserSession",
      requestType = com.orosoft.grpc.RemoveSessionRequest.class,
      responseType = com.orosoft.grpc.RemoveSessionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.orosoft.grpc.RemoveSessionRequest,
      com.orosoft.grpc.RemoveSessionResponse> getRemoveUserSessionMethod() {
    io.grpc.MethodDescriptor<com.orosoft.grpc.RemoveSessionRequest, com.orosoft.grpc.RemoveSessionResponse> getRemoveUserSessionMethod;
    if ((getRemoveUserSessionMethod = CachingServiceGrpc.getRemoveUserSessionMethod) == null) {
      synchronized (CachingServiceGrpc.class) {
        if ((getRemoveUserSessionMethod = CachingServiceGrpc.getRemoveUserSessionMethod) == null) {
          CachingServiceGrpc.getRemoveUserSessionMethod = getRemoveUserSessionMethod = 
              io.grpc.MethodDescriptor.<com.orosoft.grpc.RemoveSessionRequest, com.orosoft.grpc.RemoveSessionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "CachingService", "removeUserSession"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.orosoft.grpc.RemoveSessionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.orosoft.grpc.RemoveSessionResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new CachingServiceMethodDescriptorSupplier("removeUserSession"))
                  .build();
          }
        }
     }
     return getRemoveUserSessionMethod;
  }
  ...
  public static abstract class CachingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getUserSession(com.orosoft.grpc.UserSessionRequest request,
        io.grpc.stub.StreamObserver<com.orosoft.grpc.UserSession> responseObserver) {
      asyncUnimplementedUnaryCall(getGetUserSessionMethod(), responseObserver);
    }

    /**
     */
    public void storeUserSession(com.orosoft.grpc.UserSession request,
        io.grpc.stub.StreamObserver<com.orosoft.grpc.StoreSessionResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getStoreUserSessionMethod(), responseObserver);
    }

    /**
     */
    public void removeUserSession(com.orosoft.grpc.RemoveSessionRequest request,
        io.grpc.stub.StreamObserver<com.orosoft.grpc.RemoveSessionResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getRemoveUserSessionMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getGetUserSessionMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.orosoft.grpc.UserSessionRequest,
                com.orosoft.grpc.UserSession>(
                  this, METHODID_GET_USER_SESSION)))
          .addMethod(
            getStoreUserSessionMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.orosoft.grpc.UserSession,
                com.orosoft.grpc.StoreSessionResponse>(
                  this, METHODID_STORE_USER_SESSION)))
          .addMethod(
            getRemoveUserSessionMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.orosoft.grpc.RemoveSessionRequest,
                com.orosoft.grpc.RemoveSessionResponse>(
                  this, METHODID_REMOVE_USER_SESSION)))
          .build();
    }
  }
  ...
  public static final class CachingServiceStub extends io.grpc.stub.AbstractStub<CachingServiceStub> {
    ...
    public void getUserSession(com.orosoft.grpc.UserSessionRequest request,
        io.grpc.stub.StreamObserver<com.orosoft.grpc.UserSession> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getGetUserSessionMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void storeUserSession(com.orosoft.grpc.UserSession request,
        io.grpc.stub.StreamObserver<com.orosoft.grpc.StoreSessionResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getStoreUserSessionMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void removeUserSession(com.orosoft.grpc.RemoveSessionRequest request,
        io.grpc.stub.StreamObserver<com.orosoft.grpc.RemoveSessionResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getRemoveUserSessionMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class CachingServiceBlockingStub extends io.grpc.stub.AbstractStub<CachingServiceBlockingStub> {
    ...
    /**
     */
    public com.orosoft.grpc.UserSession getUserSession(com.orosoft.grpc.UserSessionRequest request) {
      return blockingUnaryCall(
          getChannel(), getGetUserSessionMethod(), getCallOptions(), request);
    }

    /**
     */
    public com.orosoft.grpc.StoreSessionResponse storeUserSession(com.orosoft.grpc.UserSession request) {
      return blockingUnaryCall(
          getChannel(), getStoreUserSessionMethod(), getCallOptions(), request);
    }

    /**
     */
    public com.orosoft.grpc.RemoveSessionResponse removeUserSession(com.orosoft.grpc.RemoveSessionRequest request) {
      return blockingUnaryCall(
          getChannel(), getRemoveUserSessionMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class CachingServiceFutureStub extends io.grpc.stub.AbstractStub<CachingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.orosoft.grpc.UserSession> getUserSession(
        com.orosoft.grpc.UserSessionRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getGetUserSessionMethod(), getCallOptions()), request);
    }

    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.orosoft.grpc.StoreSessionResponse> storeUserSession(
        com.orosoft.grpc.UserSession request) {
      return futureUnaryCall(
          getChannel().newCall(getStoreUserSessionMethod(), getCallOptions()), request);
    }

    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.orosoft.grpc.RemoveSessionResponse> removeUserSession(
        com.orosoft.grpc.RemoveSessionRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getRemoveUserSessionMethod(), getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_GET_USER_SESSION = 7;
  private static final int METHODID_STORE_USER_SESSION = 8;
  private static final int METHODID_REMOVE_USER_SESSION = 9;
      ...
      switch (methodId) {
        ...
        case METHODID_GET_LOGIN_ATTEMPTS:
          serviceImpl.getLoginAttempts((com.orosoft.grpc.GetLoginAttemptsRequest) request,
              (io.grpc.stub.StreamObserver<com.orosoft.grpc.GetLoginAttemptsResponse>) responseObserver);
          break;
        case METHODID_GET_USER_SESSION:
          serviceImpl.getUserSession((com.orosoft.grpc.UserSessionRequest) request,
              (io.grpc.stub.StreamObserver<com.orosoft.grpc.UserSession>) responseObserver);
          break;
        case METHODID_STORE_USER_SESSION:
          serviceImpl.storeUserSession((com.orosoft.grpc.UserSession) request,
              (io.grpc.stub.StreamObserver<com.orosoft.grpc.StoreSessionResponse>) responseObserver);
          break;
        case METHODID_REMOVE_USER_SESSION:
          serviceImpl.removeUserSession((com.orosoft.grpc.RemoveSessionRequest) request,
              (io.grpc.stub.StreamObserver<com.orosoft.grpc.RemoveSessionResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (CachingServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetUserSessionMethod())
              .addMethod(getStoreUserSessionMethod())
              .addMethod(getRemoveUserSessionMethod())
              .build();
        }
      }
    }
